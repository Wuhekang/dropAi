...
set "DOUBAO_WEB_SEARCH_MODEL=doubao-seed-2-1-turbo-260628"
set "DOUBAO_RESPONSES_BASE_URL=https://ark.cn-beijing.volces.com/api/v3"
set "DOUBAO_RESPONSES_PATH=/responses"
set "DOUBAO_MAX_RETRIES=2"

set "WRITING_REFERENCE_SEARCH_ENABLED=true"
set "WRITING_REFERENCE_SEARCH_PROVIDER=doubao_web"
...
echo   DOUBAO_WEB_SEARCH_ENABLED=%DOUBAO_WEB_SEARCH_ENABLED%
echo   DOUBAO_WEB_SEARCH_MODEL=%DOUBAO_WEB_SEARCH_MODEL%
echo   DOUBAO_RESPONSES_BASE_URL=%DOUBAO_RESPONSES_BASE_URL%
echo   DOUBAO_RESPONSES_PATH=%DOUBAO_RESPONSES_PATH%
echo   WRITING_REFERENCE_SEARCH_ENABLED=%WRITING_REFERENCE_SEARCH_ENABLED%
echo   WRITING_REFERENCE_SEARCH_PROVIDER=%WRITING_REFERENCE_SEARCH_PROVIDER%
