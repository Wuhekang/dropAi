...
public class SchoolSchemaInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        try(Connection c=dataSource.getConnection()){
            ...
            jdbc.execute(h2 ? "CREATE TABLE IF NOT EXISTS school(id BIGINT AUTO_INCREMENT PRIMARY KEY,school_code VARCHAR(64) NOT NULL UNIQUE,school_name VARCHAR(120) NOT NULL,recharge_price_per10 DECIMAL(10,2) DEFAULT 0.30 NOT NULL,student_recharge_price_per10 DECIMAL(10,2) DEFAULT 2.00 NOT NULL,student_recharge_min_price_per10 DECIMAL(10,2) DEFAULT 1.00 NOT NULL,enabled BOOLEAN DEFAULT TRUE NOT NULL,hidden BOOLEAN DEFAULT FALSE NOT NULL,deleted_at TIMESTAMP,deleted_by BIGINT,delete_reason VARCHAR(255),created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL)" : "CREATE TABLE IF NOT EXISTS school(id BIGINT PRIMARY KEY AUTO_INCREMENT,school_code VARCHAR(64) NOT NULL,school_name VARCHAR(120) NOT NULL,recharge_price_per10 DECIMAL(10,2) NOT NULL DEFAULT 0.30,student_recharge_price_per10 DECIMAL(10,2) NOT NULL DEFAULT 2.00,student_recharge_min_price_per10 DECIMAL(10,2) NOT NULL DEFAULT 1.00,enabled TINYINT(1) NOT NULL DEFAULT 1,hidden TINYINT(1) NOT NULL DEFAULT 0,deleted_at DATETIME NULL,deleted_by BIGINT NULL,delete_reason VARCHAR(255) NULL,created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,UNIQUE KEY uk_school_code(school_code)) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci");
            ...
            ensure(c,"school","hidden",h2?"BOOLEAN DEFAULT FALSE NOT NULL":"TINYINT(1) NOT NULL DEFAULT 0");
