...
public class PptProperties {
    ...
    public String provider() { return value("DOKIAI_PPT_PROVIDER", "doubao"); }
    public String apiKey() { return first("DOKIAI_PPT_ARK_API_KEY", "ARK_API_KEY", "DOUBAO_API_KEY"); }
    public String baseUrl() { return value("DOKIAI_PPT_BASE_URL", "https://ark.cn-beijing.volces.com/api/v3"); }
    public String responsesPath() { return value("DOKIAI_PPT_RESPONSES_PATH", "/responses"); }
    public String model() { return value("DOKIAI_PPT_MODEL", "doubao-seed-2-0-lite-260215"); }
    public int timeoutSeconds() { return integer("DOKIAI_PPT_TIMEOUT_SECONDS", 180); }
