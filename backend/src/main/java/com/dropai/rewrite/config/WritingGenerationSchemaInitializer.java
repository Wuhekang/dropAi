...
public class WritingGenerationSchemaInitializer implements ApplicationRunner {
    ...
    private List<String> mysqlStatements() {
        return List.of(
                ...
                "CREATE TABLE IF NOT EXISTS writing_v2_asset (id VARCHAR(64) PRIMARY KEY,project_id VARCHAR(64) NOT NULL,user_id BIGINT NOT NULL,asset_type VARCHAR(40) NOT NULL,file_name VARCHAR(255),file_path VARCHAR(700),mime_type VARCHAR(120),content_text LONGTEXT,created_at DATETIME NOT NULL,INDEX idx_writing_v2_asset_project (project_id, asset_type, created_at)) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
                "CREATE TABLE IF NOT EXISTS writing_chapter_resource (id VARCHAR(64) PRIMARY KEY,project_id VARCHAR(64) NOT NULL,chapter_id VARCHAR(64) NOT NULL,resource_type VARCHAR(40) NOT NULL,enabled TINYINT(1) NOT NULL DEFAULT 0,quantity INT NOT NULL DEFAULT 0,config_json LONGTEXT,created_at DATETIME NOT NULL,updated_at DATETIME NOT NULL,UNIQUE KEY uk_chapter_resource (chapter_id, resource_type),INDEX idx_chapter_resource_project (project_id, chapter_id)) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci",
                ...
                "ALTER TABLE writing_project ADD COLUMN paper_type VARCHAR(60) NOT NULL DEFAULT 'THEORETICAL'",
                "ALTER TABLE writing_project ADD COLUMN research_object VARCHAR(255)",
                "ALTER TABLE writing_project ADD COLUMN research_organization VARCHAR(255)",
                "ALTER TABLE writing_project ADD COLUMN research_industry VARCHAR(255)",
                "ALTER TABLE writing_project ADD COLUMN research_location VARCHAR(255)",
                "ALTER TABLE writing_project ADD COLUMN research_scene TEXT",
                ...
                "ALTER TABLE writing_reference ADD COLUMN document_type VARCHAR(80)",
                "ALTER TABLE writing_reference ADD COLUMN institution VARCHAR(255)",
                "ALTER TABLE writing_reference ADD COLUMN source_database VARCHAR(120)",
                "ALTER TABLE writing_reference ADD COLUMN external_record_id VARCHAR(255)",
                "ALTER TABLE writing_reference ADD COLUMN source_query TEXT",
                "ALTER TABLE writing_reference ADD COLUMN retrieved_at DATETIME",
                "ALTER TABLE writing_reference ADD COLUMN abstract_source_type VARCHAR(80)",
                "ALTER TABLE writing_reference ADD COLUMN verification_message TEXT",
                "ALTER TABLE writing_reference ADD COLUMN format_incomplete TINYINT(1) NOT NULL DEFAULT 0",
                "ALTER TABLE writing_reference ADD COLUMN missing_fields_json LONGTEXT",
                "ALTER TABLE writing_reference ADD COLUMN metadata_conflicts_json LONGTEXT",
                "ALTER TABLE writing_reference ADD COLUMN raw_metadata_json LONGTEXT",
                "ALTER TABLE writing_reference ADD COLUMN source_evidence_json LONGTEXT",
