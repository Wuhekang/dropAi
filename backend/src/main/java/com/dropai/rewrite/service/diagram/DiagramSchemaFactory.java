...
public class DiagramSchemaFactory {
    ...
    public JsonNode schema(DiagramType type){ObjectNode p=props(type);switch(type){
        ...
        case FUNCTION_MODULE->p.set("modules",array(obj("id","string","name","string","functions",array(typeNode("string")))));
        case ARCHITECTURE->p.set("layers",array(obj("id","string","name","string","components",array(typeNode("string")))));
        case USE_CASE->{p.set("systemId",typeNode("string"));p.set("systemName",typeNode("string"));p.set("actors",array(obj("id","string","name","string")));p.set("useCases",array(obj("id","string","systemId","string","name","string")));p.set("relations",array(obj("id","string","from","string","to","string","kind",enums("ASSOCIATION","INCLUDE","EXTEND"))));}
        case BLOCK_DIAGRAM->{p.set("blocks",array(obj("id","string","kind",enums("LEFT","CENTER","RIGHT"),"text","string")));p.set("edges",edgeArray());}
        case SEQUENCE_DIAGRAM->{p.set("participants",array(obj("id","string","kind",enums("ACTOR","BOUNDARY","CONTROL","SERVICE","DATABASE"),"name","string")));p.set("messages",array(obj("id","string","from","string","to","string","kind",enums("CALL","RETURN"),"text","string","order","integer")));}}
