...
public class DoubaoAiRewriteService implements AiRewriteService {
    ...
    private String humanizeSystemPrompt() {
        return """
                ...
                核心原则：
                优先保留工程实现内容，减少知识讲解内容。
                少讲“是什么、为什么、有什么作用”，多写“用了什么、怎么接、怎么实现、怎么测试”。
                ...
                最高优先级规则：
                1. 工程描述优先。优先保留设计、实现、调试、测试、连接、配置、参数、流程。
                2. 降低解释密度。发现“是什么→为什么→作用→优势→意义”连续出现时，压缩为一到两句。
                3. 多写实现。把知识讲解改成工程实现表达，例如“本系统采用XX……”“模块通过XX实现……”“实验中调用XX……”。
                4. 少总结。减少“具有重要意义、提供参考价值、取得良好效果、验证可行性”等空泛评价。
                5. 少用行业和媒体表达。避免技术栈、链路、场景、路径、体系、框架、赋能、协同、生态、闭环、落地等词堆叠。
