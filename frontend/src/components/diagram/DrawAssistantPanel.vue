<template>
  <section class="draw-assistant" :data-stage="stage">
    <div class="visual" aria-live="polite">
      <div class="character-picture" role="img" :aria-label="`原创绘图助手：${label}`"><span class="character-v2" :class="`is-${stage}`"><img src="/draw-assistant/v2-state-overview.png" alt="" draggable="false"></span></div>
